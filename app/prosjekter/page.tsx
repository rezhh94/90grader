...
export default function ProjectsPage() {
  ...
  return (
    <div className="bg-[#181618] text-[#e6e5de] font-sans selection:bg-[#2eff9b] selection:text-[#181618] min-h-screen">
      <div className="max-w-[1400px] mx-auto px-6 py-20">
        ...
        {/* Metrics Grid mimicking FeatureCards / Solid Erfaring */}
          ...
          <div className="bg-white/5 border border-white/10 backdrop-blur-sm px-8 py-12 rounded-2xl flex flex-col items-center gap-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 w-full gap-8 justify-between">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="font-mono font-bold text-[10px] uppercase text-[#e6e5de]/80 tracking-widest">
                  Referanse_Noder
                </div>
              </div>
